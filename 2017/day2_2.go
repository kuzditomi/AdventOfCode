...
var puzzle = `4347	3350	196	162	233	4932	4419	3485	4509	4287	4433	4033	207	3682	2193	4223
...
var errNoPair = errors.New("no pair found")

func divideIfPairExists(numbers []int, number int) (int, error) {
...
func main() {
	...
	for _, row := range rows {
		...
		for _, n := range parts {
			...
			divisionResult, err := divideIfPairExists(numbersInRow, current)
			...
			numbersInRow = append(numbersInRow, current)
		}
	}
